...
public class Main {
    ...
    public static void main(String[] args) {
        for (int i = 1; i < 11; i++) {
            ...
            switch (new Random().nextInt(7)) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    holyTeam.add(new Witcher(getName(), new Coord(i, 1)));
                    break;
            }
            ...
            switch (new Random().nextInt(7)) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    darkTeam.add(new Witcher(getName(), new Coord(i, 10)));
                    break;
            }
        }
        ...
        allTeam.sort(Comparator.comparingInt(Unit::getSpeed).reversed());
